...
<div data-role="page">
    <div data-role="content">
        ...
        <c:url var="formAction" value="/biz/video/genSnapshot"/>
        <form method="post" name="form_data" id="form_data" action="${formAction}">
            ...
            <div>
                <input type="text" id="startSecond" name="startSecond" placeholder="请输入从第几秒起始" required="required">
            </div>
            ...
            <div>
                <input type="text" id="interval" name="interval" placeholder="请输入抽帧间隔" required="required">
            </div>
            <div>
                <h4>个数</h4>
            </div>
            <div>
                <input type="text" id="cnt" name="cnt" placeholder="请输入抽帧个数" required="required">
            </div>
            ...
            <input type="submit" id="submit" value="开始抽帧">
        </form>
    </div>
</div>
