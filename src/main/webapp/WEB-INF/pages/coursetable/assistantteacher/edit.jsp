...
<body>
  ...
  <div style="margin:20px 0px 0px 160px;">
    ...
    <div data-role="content">
      <s:url var="formEditAction" value="/coursetable/assistantteacher/edit_summit.action" />
      <s:url var="formDelAction" value="/coursetable/assistantteacher/del_commit.action" />
      <form method="post" name="form_data" id="form_data">
        ...
        <div class="ui-field-contain">
			...
			<input type="text" id="idNum"
				...
				placeholder="请输入正确的身份证号码" required="required" form="form_data" data-clear-btn="true" value="${model.idNum }">
		</div>
		<div class="ui-field-contain">
