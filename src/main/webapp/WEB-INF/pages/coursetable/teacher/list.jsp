  ...
  <div data-role="page">
    ...
    <div data-role="main" class="ui-content jqm-content">
   		<form class="ui-filterable" id="addForm">
	 		...
	 		<s:url var="addAction" value="/coursetable/teacher/add.action" />
	    ...
	    <ul data-role="listview" data-inset="true" data-filter="true" data-input="#myFilter">
	       <li>授课教师列表</li>
	        <s:iterator value="#request.teacherInfos" var="info">
	          <s:url var="editActionUrl" value="/coursetable/teacher/edit.action">
