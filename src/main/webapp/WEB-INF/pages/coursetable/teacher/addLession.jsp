	...
	<div data-role="page">
		...
		<div data-role="content">
			<s:url var="formAction"
				value="/coursetable/teacher/add_lession_submit.action" />
			<form method="post" name="form_data" id="form_data"
				...
				<div class="ui-field-contain">
					...
					<input type="text" id="name" name="name" placeholder="请输入课程名称"
			    ...
			    <div class="ui-field-contain" align="center">
			    	...
			    	<button class="ui-btn ui-btn-inline ui-shadow ui-corner-all" type="button" id="listBtn" >返回课程列表</button>
				</div>
			</form>
		</div>
	</div>
