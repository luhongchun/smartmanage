...
<div class="weui_msg">
  ...
  <div class="weui_text_area">
    <h2 class="weui_msg_title">业务未办理</h2>
    <p class="weui_msg_desc">您尚未开通该业务，请联系幼儿园办理</p>
  </div>

  <div class="weui_opr_area">
    <p class="weui_btn_area">
      <a href="javascript:void(0)" class="weui_btn weui_btn_primary" onclick="showMaskDlg()"
         style="display:none;">联系幼儿园</a>
